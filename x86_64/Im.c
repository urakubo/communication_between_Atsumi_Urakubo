...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Im /home/urakubo/murayama/model/model_Leleo_Segev/Im.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/urakubo/murayama/model/model_Leleo_Segev/Im.mod";
static const char* nmodl_file_text = 
