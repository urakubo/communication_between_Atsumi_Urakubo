...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 ProbUDFsyn2 /home/urakubo/murayama/model/model_Leleo_Segev/ProbUDFsyn2.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 84 in file ProbUDFsyn2.mod:\n        SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/urakubo/murayama/model/model_Leleo_Segev/ProbUDFsyn2.mod";
static const char* nmodl_file_text = 
